...
class LiveBarcodeScanningFragment : DialogFragment(), OnClickListener {
  ...
  override fun onCreateView(
    ...
    return layoutInflater.inflate(R.layout.fragment_live_barcode, container, false)
  }

  override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
    super.onViewCreated(view, savedInstanceState)
    graphicOverlay =
      view.findViewById<GraphicOverlay>(R.id.camera_preview_graphic_overlay).apply {
    ...
    flashButton =
      view.findViewById<View>(R.id.flash_button).apply {
        setOnClickListener(this@LiveBarcodeScanningFragment)
      }
    setUpWorkflowModel()
  }
