...
"""
  ...
  fun integerTextEdit_typingZeroBeforeAnyIntegerShouldKeepZeroDisplayed() = runComposeUiTest {
    ...
    val getQuestionnaireResponse = setQuestionnaireContent("files/text_questionnaire_integer.json")
  ...
  fun decimalTextEdit_typingZeroBeforeAnyIntegerShouldKeepZeroDisplayed() = runComposeUiTest {
    val getQuestionnaireResponse = setQuestionnaireContent("files/text_questionnaire_decimal.json")
  ...
  fun sliderValueToShouldComeFromTheMaxValueExtensionWithCQF_calculatedValue() = runComposeUiTest {
    setQuestionnaireContent("files/component_slider_with_max_cqf_calculatedValue.json")
    onNodeWithTag(SLIDER_TAG)
      .assertRangeInfoEquals(ProgressBarRangeInfo(current = 0f, range = 0f..127f, steps = 126))
  }

  @Test
  fun sliderValueToShouldComeFromTheMinValueExtensionWithCQF_calculatedValue() = runComposeUiTest {
    setQuestionnaireContent("files/component_slider_with_min_cqf_calculatedValue.json")
    onNodeWithTag(SLIDER_TAG)
      .assertRangeInfoEquals(ProgressBarRangeInfo(current = 18f, range = 18f..100f, steps = 81))
  }
  ...
  fun datePicker_shouldSetDateInput_withinRange() = runComposeUiTest {
    ...
    val getQuestionnaireResponse = setQuestionnaireContent(questionnaire)
